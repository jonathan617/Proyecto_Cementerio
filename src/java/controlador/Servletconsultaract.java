 ...
 * @author jonat
 */
@WebServlet(name = "Servletconsultaract", urlPatterns = {"/Servletconsultaract"})
public class Servletconsultaract extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        arr=actdao.consultageneralactividad();
        Gson gson=new Gson();
