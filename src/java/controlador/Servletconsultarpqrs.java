 ...
 * @author jonat
 */
@WebServlet(name = "Servletconsultarpqrs", urlPatterns = {"/Servletconsultarpqrs"})
public class Servletconsultarpqrs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        arr=pqrsdao.consultageneralPQRS();
        Gson gson=new Gson();
